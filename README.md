...
Runtime files such as `secrets.yaml`, Home Assistant databases, logs, cache directories, custom components, the `www/` folder, and generated local state are intentionally ignored.
